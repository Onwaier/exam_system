		...
		<div id="page-wrapper">
			...
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade in active" id="manualInput">
					...
					<form class="form-inline" id = "formQuestion" action="${pageContext.request.contextPath }/question/update.action" method="post" onsubmit="return checkAddQuestion()">		
	...
	<script type="text/javascript">
		function checkAddQuestion(){
			...
			<%-- $.ajax({  
                type:'post',  
                dataType : "json",
                url: "<%=basePath%>question/update.action",
