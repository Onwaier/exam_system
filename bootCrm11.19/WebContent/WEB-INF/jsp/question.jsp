...
<!-- 										<form class="navbar-form navbar-left" method="post"> -->
												<button onclick="window.location.href='${pageContext.request.contextPath }/question/edit.action?qid=${row.qid}'" class="btn btn-default" type="submit">
														修改
												</button>
												<button class="btn btn-default" type="button" onclick="deleteQuestion(${row.qid})">
														删除
												</button>
<!-- 										</form> -->
