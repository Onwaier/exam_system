...
<body>
	...
	<!--                                 	<textarea rows="2" cols="80"></textarea> -->
						...
						<button class="btn btn-primary navbar-input-button" onclick="window.open('${pageContext.request.contextPath }/question/fileUpload.action', 'loadPicture')" type="button">录入</button>				
				...
				<div class="tab-pane fade" id="fileInput">
				        ...
				        <div id="wordImport" style="display:none">
				            ...
				            <div class="btn-row" style="text-align: center;">
				                ...
				                <!-- <input id="file_upload" name="file_upload" type="file" multiple="true"/> -->
				                <form id="uploadForm" class="upload-form">
				                    <div class="btn btn-primary upload">上传word<input type="file" onchange="importf(this)" name="uploadFile" id="excelUpload"/></div>
	...
	<script type="text/javascript">
		$(".addKeyBtn").click(function(e){
		    ...
		    var html =  '   <div class="keyLeft">'+
		                '        <input type="' + input_type + '" class="radioOrCheck" name="answers" value = "" onclick = "getValue()"/>'+
