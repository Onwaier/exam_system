...
<c:choose>
    <c:when test="${not empty fileList }">
        ...
        <c:forEach items="${fileList }" var="file">
            ...
            <!-- rootdir:文件的目录 -->
            <c:set var="rootdir" value='${pageContext.request.contextPath}/wordTemplate/'></c:set>
            <div>
            <img alt='${fileanme }' src='${rootdir.concat(filefullname) }'><!-- 文件的全路径 -->
                <a href="${pageContext.request.contextPath}/question/downloadWord.action?filename=${filefullname}">${filefullname}下载</a>
