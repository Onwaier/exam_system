...
/*		//参数回显
	...
	public String questionAdd(Long qid, String subject, String type, String optionA, String optionB, String optionC, String optionD,  String optionE, String optionF, String optionG, 
			String answerOption, String answerJudge, @RequestParam("answerFill[]") String[] answerFills, String answerCloze, 
			String courseName, String analysis, String chapter, String knowPoint, String difficulty) {
		
		System.out.println("/question/add " + "  answerOption: " + answerOption + "   answerJudge: " + answerJudge + "   answerCloze: " + answerCloze);
		...
		if (!uploadfile.isEmpty() && uploadfile.size() > 0) {
			...
			for (MultipartFile file : uploadfile) {
				...
				try {
					...
					pictureUrl = dirpath +File.separator+ newFilename;
				} catch (Exception e) {
