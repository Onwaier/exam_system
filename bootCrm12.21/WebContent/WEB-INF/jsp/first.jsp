...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no" >
	<DIV
		...
		<SPAN style="padding-right: 20px; float: right;" class="head">
			...
			我们的考试系统</SPAN> <SPAN style="padding-left: 15px;" id="News"></SPAN>
	</DIV>
	...
	<DIV style="width: 180px;" id="west" title="导航菜单" split="true"
		...
		<DIV id="nav" class="easyui-accordion" border="false" fit="true">
			...
			<!-- <li><div>
					<a title="题库管理" ref="1_1" href="#"
						rel="/question/list.action" icon="icon-log"><span
						class="icon icon-log">&nbsp;</span><span class="nav"><a href=javascript:addTab('创建采购单','${baseurl}item/query.action')>商品查询</a></span></a>
				</div></li>
			<li><div>
					<a title="试卷管理" ref="1_1" href="#"
						rel="/question/paper.action?type=1" icon="icon-log"><span
